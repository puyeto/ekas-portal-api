...
// ConfiguredDevices ...
func (s *DeviceService) ConfiguredDevices(rs app.RequestScope, offset, limit int) ([]models.DeviceConfiguration, error) {
	return s.dao.ConfiguredDevices(rs, offset, limit)
}
